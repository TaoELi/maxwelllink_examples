...
mxl_driver --model rtehrenfest --address $HOST --port $PORT --param "molecule_xyz=../tddft_benchmark/hcn.xyz, functional=b3lyp, dft_grid_name=SG1, basis=cc-pvdz, dt_rttddft_au=0.04, memory=16GB, num_threads=16" --verbose
